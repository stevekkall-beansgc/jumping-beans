...
await document.modelContext.registerTool(
  {
    ...
    description:
      "Return Coffee Co catalog offers in the given categories, optionally under a max price and redacted preference plane. The opted-in shop supplies records from a public feed; Jumping Beans has not independently verified them.",
    inputSchema: {
      type: "object",
      properties: {
